...
@section('content')
    <div id="index-banner" class="parallax-container">
            ...
            <div class="container">
                ...
                @elseif (session('error'))
                    <div class="alert alert-error">
                        {{ 'Error al envuar el emnsaje, favor de intentar más tarde' }}
                    </div>
                @endif
        ...
        <div class="parallax"><img src="{{asset('img/bg/background1.jpg')}}" alt="Unsplashed background img 1"></div>
    </div>
    ...
    <div class="parallax-container valign-wrapper">
        ...
        <div class="parallax"><img src="{{asset('img/bg/background2.jpg')}}" alt="Unsplashed background img 2"></div>
    </div>
    ...
    <div class="parallax-container valign-wrapper">
        ...
        <div class="parallax"><img src="{{asset('img/bg/background3.jpg')}}" alt="Unsplashed background img 3"></div>
    </div>
        ...
        <div class="section">
            ...
            <div class="row">
                <div class="col s12 center">
                    <h3><i class="mdi-content-send brown-text"></i></h3>
                    <h4>Contactanos</h4>
                    <form action="{{route('SendMessage')}}" method="get">
                        <div class="col s6">
                        ...
                        <div class="col s6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="exampleInputPassword1"
                                       placeholder="Apellido" name="last-name">
                            </div>
                        </div>
                        <div class="col s6">
                            <div class="form-group">
